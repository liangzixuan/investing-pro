...
| Local integration          | Format, lint, guardrails, all project typechecks/tests, and builds pass on frozen bytes                                                             | Pass: 39 files; 846 passed + 2 POSIX-only Windows skips (848 total cases); 86 production-license checks |
