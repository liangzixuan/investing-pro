...
security-master admission and search is accepted and promoted only for exact
source revision `5b547c88f213cfbc10450c460528a97ee395a834` and the declared
personal scope, with private evidence limited publicly to its permitted coarse
outcome. That later promotion does not make this process-memory state durable.
