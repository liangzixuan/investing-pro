...
Later measurement-integrity status: **Cycle 3e-a2 has a recorded public
...
literals into its receipt. Cycle 3e-a2 has a recorded public engineering Pass
only for exact source `8c2166fa01f5e1f471887ccdeb9484b132a02bb0` and routing
closure `0374becdf96c1e9891d80e73024c8be0440fd812`. Source local verification
passed 2,058 tests with 9 intentional skips. Attempt-1 CI run `33816810188`
...
Routing local verification passed 2,060 tests with 9 intentional skips, and
independent review was clean. Attempt-1 CI run `33823588896` passed jobs
...
normalization run was triggered or required by the exact five-path routing
transition. That record does not authorize the later real operation or prove
real breadth or latency.
