...
bootstrap as a least-privileged migration. B6 later added only a post-bootstrap
owner-DDL canary and did not close this gate; the full versioned split remains
reserved for B7.
