...
Current status: **implementation and focused hostile-carrier coverage are
present. The prior Cycle 2a through Cycle 2g bounded owned-byte security
conclusions are Superseded. The exact final frozen-byte working-tree local gate
is Pass. The source commit, Ubuntu/Windows CI, parser live acceptance, and
custody live acceptance remain Pending.** Cycle 2b, full Cycle 2 quality, and production admission remain
Blocked. Cycle 2f's original `72e91f5` conclusion remains Superseded; its
restored bounded claim and Cycle 2g's bounded claim at
`df1ddffdede9900302da34160ce6b9a62b9d1708` are now also Superseded pending
Cycle 2h promotion.

| Gate                             | Required result                                                                                                                                                                                                                                                                                                                                                                                                                                       | Current status                                                              |
| -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| Exact ingress inventory          | Every public or injected Cycle 2a–2g byte role is enumerated: parser archive, signer signature output, create/start/remove/residue process-runner stdout/stderr; seven admission documents; custody payload, five semantic entropy results, and key-store reads/writes; two normalization documents; two comparison reports; three quality-measurement documents; three quality-precommitment documents                                               | Implemented; final gate Pending                                             |
| Intrinsic slot/type reads        | Intrinsic typed-array `buffer` and `byteLength` getters plus the intrinsic `%TypedArray%.prototype[Symbol.toStringTag]` getter recover backing, actual length, and element type before any proxy-sensitive prototype check                                                                                                                                                                                                                            | Implemented; final gate Pending                                             |
| Exact carrier and backing        | Only intrinsic element type `Uint8Array` with exact `Uint8Array.prototype`, intrinsic-validated `ArrayBuffer` backing, and exact `ArrayBuffer.prototype` is accepted. Carriers retaining subclass or foreign-realm prototypes fail exact-prototype admission; re-prototyped `Int8Array`, `Uint8ClampedArray`, and `Uint16Array`, proxies, detached buffers, shared or re-prototyped shared backing, other views, and spoofed own metadata fail closed | Implemented; final gate Pending                                             |
| Limit before allocation          | Each role's actual internal byte length is checked against its exact or maximum contract before any owned-snapshot allocation, including exact 64-byte signatures and each process request's stdout/stderr limits                                                                                                                                                                                                                                     | Implemented; final gate Pending                                             |
| Hook-free owned copy             | A direct ordinary `Uint8Array` allocation plus intrinsic `Uint8Array.prototype.set.call` copies bytes without caller iterator, constructor, species, instance `set`, `buffer`, or `byteLength` dispatch                                                                                                                                                                                                                                               | Implemented; final gate Pending                                             |
| Cycle 2a oversize semantics      | An oversized exact carrier is synchronously SHA-256 hashed without an owned copy, returns the existing signed `archive_limit_exceeded` quarantine, and never starts the worker                                                                                                                                                                                                                                                                        | Implemented; final gate Pending                                             |
| Coarse failure preservation      | Existing Cycle 2a–2g invalid-input, document/report-invalid, hash-mismatch, quarantine, value-free diagnostic, and zero-partial-result mappings remain unchanged                                                                                                                                                                                                                                                                                      | Implemented; final gate Pending                                             |
| Mutation ownership               | Every accepted in-limit role is copied before parsing, validation, asynchronous work, storage, or comparison, and later caller mutation cannot change the owned snapshot                                                                                                                                                                                                                                                                              | Implemented; final gate Pending                                             |
| Hostile role matrix              | Metadata shadows, own throwing `Symbol.toStringTag`, accessors, iterators, constructors, species, instance methods, shared/oversized backing, re-prototyped `Int8Array`/`Uint8ClampedArray`/`Uint16Array`, subclasses, detached views, proxies, and mutation are exercised across every affected role                                                                                                                                                 | Focused coverage present; final gate Pending                                |
| Cycle 2f / Cycle 2g hardening    | Their six plan/candidate/reference roles add intrinsic `Uint8Array` element-type and `ArrayBuffer` brand validation with safe prototype-check ordering while preserving all non-carrier schemas, arithmetic, state, capability, and delegation semantics                                                                                                                                                                                              | Implemented; final gate Pending                                             |
| Exact transition                 | The atomic diff from `14f76bbd29fb51c37d7ba0c8c8d6c9b06cedac98` is exactly 40 paths: 38 modified and two added                                                                                                                                                                                                                                                                                                                                        | Implemented in working tree; source commit Pending                          |
| Historical evidence preservation | Canonical Cycle 2a/Cycle 2c live evidence schemas, artifacts, notes, checks, nonclaims, and source sets remain unchanged. The existing local custody fixture manifest refreshes only the SHA-256 entries for the changed custody source and security-test files; fixture cases, schema, order, and payload identity/content remain unchanged                                                                                                          | Implemented; live commit-bound review Pending                               |
| Full local gate                  | Formatting, ESLint, all guardrails, production-license review, all scripted typechecks/tests/builds, and both historical boundary verifiers pass on the exact final bytes                                                                                                                                                                                                                                                                             | Pass — expected inventory: 47 files; 1,017 passed + 2 skipped (1,019 total) |
| Two-OS CI                        | The existing frozen-source CI matrix passes on Ubuntu and Windows for the exact source commit                                                                                                                                                                                                                                                                                                                                                         | Pending                                                                     |
| Parser live acceptance           | The existing dedicated parser workflow completes runtime acceptance and its commit-bound offline review accepts the exact Cycle 2h transition without mutating canonical Cycle 2a evidence                                                                                                                                                                                                                                                            | Pending                                                                     |
| Custody live acceptance          | The existing dedicated custody workflow completes runtime acceptance and its commit-bound offline review accepts the exact cumulative Cycle 2c history without mutating canonical Cycle 2c evidence                                                                                                                                                                                                                                                   | Pending                                                                     |
...
final frozen-byte working-tree local gate is Pass; the source-bound and remote
...
It is not promoted while any Pending gate above remains.
...
conclusions are now Superseded pending Cycle 2h. Their schemas, fixed checks,
...
Promotion requires one exact source commit binding the working-tree bytes whose
local gate is Pass, plus a passing existing Ubuntu/Windows CI matrix and both
existing dedicated parser and custody live-acceptance workflows including
commit-bound review. Failure, cancellation, a partial or extra transition path, unreviewed
...
any real-data input prevents promotion.
