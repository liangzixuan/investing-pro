...
export interface SyntheticFilingParserNormalizationExecutionFixture {
  readonly amendmentArchive: Uint8Array;
  readonly amendmentDocumentBytes: Uint8Array;
  readonly originalArchive: Uint8Array;
  readonly originalDocumentBytes: Uint8Array;
}
...
export function buildSyntheticFilingParserNormalizationExecutionFixture(): SyntheticFilingParserNormalizationExecutionFixture {
  const originalSource: ArchiveSource = {
  ...
  const amendmentSource: ArchiveSource = {
  ...
  return Object.freeze({
    amendmentArchive,
    amendmentDocumentBytes: buildDocumentBytes(
      amendmentSource,
      amendmentArchive,
    ),
    originalArchive,
    originalDocumentBytes: buildDocumentBytes(originalSource, originalArchive),
  });
}
...
function buildDocumentBytes(
  ...
  return canonicalBytes({
    ...
    entityId: "entity.synthetic.syn1",
    facts: FACT_CONTRACTS.map(([key, concept, periodKind, unit]) => ({
      concept,
      dimensions: {},
      key,
      periodEnd: "2025-12-31",
      periodStart: periodKind === "instant" ? null : "2025-01-01",
      unit,
