...
ALTER FUNCTION private_data.has_active_membership(uuid, text[])
  OWNER TO research_cockpit_owner;
ALTER FUNCTION private_data.has_active_entitlement(uuid, text)
  OWNER TO research_cockpit_owner;
ALTER FUNCTION shared_data.rights_allow_current_use(text, text)
  OWNER TO research_cockpit_owner;
