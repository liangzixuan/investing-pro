...
ALTER TABLE private_data.organizations OWNER TO research_cockpit_owner;
ALTER TABLE private_data.principals OWNER TO research_cockpit_owner;
ALTER TABLE private_data.organization_principals
  OWNER TO research_cockpit_owner;
ALTER TABLE private_data.memberships OWNER TO research_cockpit_owner;
ALTER TABLE private_data.entitlements OWNER TO research_cockpit_owner;
ALTER TABLE private_data.theses OWNER TO research_cockpit_owner;
ALTER TABLE private_data.alert_rules OWNER TO research_cockpit_owner;
ALTER TABLE private_data.idempotency_records OWNER TO research_cockpit_owner;
ALTER TABLE private_data.audit_events OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.rights_policies OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.rights_grants OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.issuers OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.securities OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.share_classes OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.exchanges OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.listings OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.symbol_history OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.evidence OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.financial_facts OWNER TO research_cockpit_owner;
ALTER TABLE shared_data.metric_definitions OWNER TO research_cockpit_owner;
