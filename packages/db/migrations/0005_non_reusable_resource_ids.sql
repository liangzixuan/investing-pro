...
ALTER TABLE private_data.resource_id_registry
  OWNER TO research_cockpit_owner;
ALTER FUNCTION private_data.guard_resource_id_registry()
  OWNER TO research_cockpit_owner;
ALTER FUNCTION private_data.tombstone_resource_id_after_delete()
  OWNER TO research_cockpit_owner;
ALTER FUNCTION private_data.guard_live_resource_identity()
  OWNER TO research_cockpit_owner;
